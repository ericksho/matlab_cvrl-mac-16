...
function varargout = Bfx_gui2(varargin)
% BFX_GUI2 M-file for Bfx_gui2.fig
%      BFX_GUI2, by itself, creates a new BFX_GUI2 or raises the existing
%      singleton*.
%
%      H = BFX_GUI2 returns the handle to a new BFX_GUI2 or the handle to
%      the existing singleton*.
%
%      BFX_GUI2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in BFX_GUI2.M with the given input arguments.
%
%      BFX_GUI2('Property','Value',...) creates a new BFX_GUI2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Bfx_gui2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Bfx_gui2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Bfx_gui2

% Last Modified by GUIDE v2.5 26-May-2011 09:43:59

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @Bfx_gui2_OpeningFcn, ...
    'gui_OutputFcn',  @Bfx_gui2_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before Bfx_gui2 is made visible.
function Bfx_gui2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Bfx_gui2 (see VARARGIN)

% Choose default command line output for Bfx_gui2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Bfx_gui2 wait for user response (see UIRESUME)
...
function varargout = Bfx_gui2_OutputFcn(hObject, eventdata, handles)
...
[N,M,P] = size(Imgnow);
switch fextractor.segmentation
    case 1
        [R,E,J] = Bim_segbalu(Imgnow);
    case 2
        [R,E,J] = Bim_segbalu(Imgnow,0.15);
    case 3
        [R,E,J] = Bim_segbalu(Imgnow,-0.15);
    case 4
        [R,E,J] = Bim_segbalu(Imgnow);
